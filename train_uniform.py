...
time_step = 120
batch_size = 42
# MAE: {65, 66, 68, 70, 7, 42, 43, 22, 24, 28}
target_region = 28
...
for epoch in range(epochs):
    ...
    if epoch*train_batch + i + 1 >= 900:  # 900
        break
...
# shutil.copy('{}.pkl'.format(best_epoch), 'E:/AIST_MSE/' + str(target_region) + '_' + str(target_cat) + '_F.pkl')
model.load_state_dict(torch.load('{}.pkl'.format(best_epoch)))
# model.load_state_dict(torch.load("Heatmap/" + str(target_region) + "_" + str(target_cat) + ".pkl"))

f = open('C:/Users/Yeasir Rayhan/PycharmProjects/AIST/aist_eval_module_mse.txt','a')
