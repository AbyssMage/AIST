...
time_step = 120
batch_size = 42
target_region = d.tr  # 66 68 70 7 71 42 43 48 22 23 24
...
x_daily = x_daily[:, 10: ]
# print(x.shape, x_daily.shape, x_weekly.shape)
...
def compute_test():
    ...
    print(Q, " ", target_region, " ", target_cat, " ", loss/i)
    print(Q, " ", target_region, " ", target_cat, " ", loss/i, file=f)
