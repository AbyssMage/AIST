...
shutil.copy('{}.pkl'.format(best_epoch), 'E:/AIST_ADV/' + str(target_region) + '_' + str(target_cat) + '_F.pkl')
...
f = open('C:/Users/Yeasir Rayhan/PycharmProjects/AIST/aist_eval_module_mae.txt', 'a')
