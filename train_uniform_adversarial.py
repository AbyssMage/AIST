...
import os
from utils import *
from model_uniform_adversial import *
from layers_uniform_adversial import *
...
shutil.copy('{}.pkl'.format(best_epoch), 'E:/AIST_UNI/' + str(target_region) + '_' + str(target_cat) + '_' + str(seed) + '_SEED.pkl')
...
f = open('C:/Users/Yeasir Rayhan/PycharmProjects/AIST/aist_eval_module_uniform_adv.txt', 'a')
...
def compute_test():
    ...
    print(target_region, " ", target_cat, " ", total_loss_test.data.item(), " ", tvd.data.item(), " ", jsd.data.item(), file=f)
